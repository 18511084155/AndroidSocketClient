...
import com.woodys.libsocket.impl.blockio.IOManager;
import com.woodys.libsocket.impl.exceptions.UnconnectException;
import com.woodys.libsocket.sdk.ConnectionInfo;
import com.woodys.libsocket.sdk.OkSocketOptions;
import com.woodys.libsocket.sdk.OkSocketSSLConfig;
...
import com.woodys.libsocket.sdk.protocol.DefaultX509ProtocolTrustManager;
    ...
    private class ConnectionThread extends Thread {
        ...
        public void run() {
            try {
                ...
                isConnectTimeout = false;
                SLog.i("开始连接 " + mConnectionInfo.getIp() + ":" + mConnectionInfo.getPort() + " Socket服务器");
                ...
                SLog.i("Socket服务器连接成功 " + mConnectionInfo.getIp() + ":" + mConnectionInfo.getPort());
            } catch (Exception e) {
                if (isConnectTimeout) {//超时后不处理Socket异常
                    return;
                }
                SLog.i("连接 " + mConnectionInfo.getIp() + ":" + mConnectionInfo.getPort() + " 出现异常:" + e.getMessage());
                mConnectionTimeout.removeCallbacksAndMessages(null);
